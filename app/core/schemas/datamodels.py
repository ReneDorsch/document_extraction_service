...
class Document(BaseModel):
    ...
    metadata: MetaData = Field(default=None,
                               description='Metadata identified by analysing the pdf-document.')
    text: Text = Field(default=None,
                       description="The extracted textinformation of the document. ")
    tables: List[Table] = Field(default=[],
                                description="A list of tables extracted from the document. ")
    images: List[Image] = Field(default=[],
                                description="A list of images extracted from the document. ")
